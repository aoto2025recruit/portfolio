...
$(window).on('load',function(){
	...
	$(".container_load").delay(1800).fadeOut('slow');//ロゴを1.2秒（1200ms）待機してからフェードアウト
	$(".center_svg").delay(1800).fadeOut('slow');//ロゴを1.2秒（1200ms）待機してからフェードアウト
	$("#load").delay(1800).fadeOut('slow');//ロゴを1.2秒（1200ms）待機してからフェードアウト
	setTimeout(() => {
